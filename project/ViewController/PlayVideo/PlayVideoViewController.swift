...
class PlayVideoViewController: BaseViewController  {
    ...
    @IBOutlet weak var moreSelectView: UIView!
...
//            UIApplication.mainVC()?.slideUpPanelManagerVideo.overlayPanGR.isEnabled = true
    ...
    override func viewDidLoad() {
        ...
        moreSelectView.alpha = 0
        moreSelectView.isHidden = true
        moreSelectView.layer.borderColor = UIColor.white.cgColor
        moreSelectView.layer.borderWidth = 0.5
        moreSelectView.layer.cornerRadius = 10
        moreSelectView.clipsToBounds = true
    ...
    @IBAction func moreButton(_ sender: Any) {
        ...
        if isShow {
            UIView.animate(withDuration: 0.3) {
                self.moreSelectView.alpha = 1
                self.moreSelectView.isHidden = false
            }
        } else {
            UIView.animate(withDuration: 0.3) {
                self.moreSelectView.alpha = 0
                self.moreSelectView.isHidden = true
            }
        }
    }
...
//            make.height.equalTo(40)
    ...
    func setStatePlayButton(isPlaying: Bool)  {
        if isPlaying {
            self.btnPlayClick.setImage(#imageLiteral(resourceName: "pause_new"), for: .normal)
            ...
            self.btnPlayClick.setImage(#imageLiteral(resourceName: "play_new"), for: .normal)
