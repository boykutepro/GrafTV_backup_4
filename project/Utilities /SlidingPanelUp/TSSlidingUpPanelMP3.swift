...
class TSSlidingUpPanelManager_MP3: NSObject {
    ...
    var overlayPanGR: UIPanGestureRecognizer!
    ...
    func initPanelWithTabBar(inView: UIView, tabBar: UITabBar, slidingUpPanelView: UIView, slidingUpPanelHeaderSize: CGFloat) {
        ...
        view_MP3.insertSubview(slidingUpPanelView, belowSubview: tabBar)
        setSlideUpPanelState()
    }
    ...
    func scaleNumber(oldValue: CGFloat, newMin: CGFloat, newMax:CGFloat) -> CGFloat {
        ...
        let max = view_MP3.frame.height + min  - tabBarFrameHeight + headerSize
    ...
    private func initlizeParams(inView: UIView, slidingUpPanelView: UIView, slidingUpPanelHeaderSize: CGFloat) {
        ...
        self.minOverlayYPos         = view_MP3.frame.height - (tabBarFrameHeight + headerSize)
        self.originTabBarYPos       = self.tabBar != nil ? tabBar.frame.origin.y : view_MP3.frame.height
    ...
    @objc private func panSlideUpView(sender: UIPanGestureRecognizer) {
        ...
        let tabBarYPos  = scaleNumber(oldValue: yPos, newMin: viewFrameHeight, newMax: viewFrameHeight + 64)
